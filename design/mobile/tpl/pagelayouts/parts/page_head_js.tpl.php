...
<script type="text/javascript" language="javascript" src="<?=erConfigClassLhConfig::getInstance()->getSetting( 'cdn', 'css' )?><?=erLhcoreClassDesign::design('js/hw.js');?>?v=3"></script>
<script type="text/javascript" language="javascript" src="<?=erConfigClassLhConfig::getInstance()->getSetting( 'cdn', 'css' )?><?=erLhcoreClassDesign::design('js/mobile.js');?>"></script>
