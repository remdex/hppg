...
(function($) {
  ...
  Sketch = (function() {
      ...
      if (this.options.toolLinks) {
        $('body').delegate("a[href=\"#" + (this.canvas.attr('id')) + "\"]", 'click', function(e) {
          ...
          if ($(this).attr('data-download')) {
            sketch.download($(this).attr('data-download'),$(this).attr('data-url'));
          }
          return false;
        });
      }
    ...
    Sketch.prototype.download = function(format,url) {
      var mime;
      format || (format = "png");
      if (format === "jpg") {
        format = "jpeg";
      ...
      $.postJSON(url,{img:this.el.toDataURL(mime)}, function(data){ 
