...
<? 
    $items = erLhcoreClassModelGalleryImage::getImages(array('filter_shard' => $filter_shard, 'smart_select' => true,'disable_sql_cache' => true,'filter' => $filterArray, 'sort' => 'pid DESC','offset' => $pages->low, 'limit' => $pages->items_per_page));
?>   
