...
var uploader = new qq.FileUploader({
	...
	template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button"><?=erTranslationClassLhTranslation::getInstance()->getTranslation('gallery/publicupload','Click to choose zip to upload, you can also drop files here (Darg and rop only for FF, Chrome).')?></div>' +
