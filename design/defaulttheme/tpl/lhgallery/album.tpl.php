...
<? if ($pages->items_total > 0) { ?>         
  <?  
      $items = erLhcoreClassModelGalleryImage::getImages(array('sort' => $modeSQL,'cache_key' => 'albumlist_'.CSCacheAPC::getMem()->getCacheVersion('album_'.$album->aid).$appendCacheKey,'filter' => array('aid' => $album->aid)+$filterArray,'offset' => $pages->low, 'limit' => $pages->items_per_page));
  ?>      
