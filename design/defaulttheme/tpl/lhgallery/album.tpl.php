...
<? if ($pages->items_total > 0) { ?>         
  <?  
      $items = erLhcoreClassModelGalleryImage::getImages(array('smart_select' => true,'sort' => $modeSQL,'disable_sql_cache' => true,'filter' => array('aid' => $album->aid)+$filterArray,'offset' => $pages->low, 'limit' => $pages->items_per_page));
  ?>      
