            ...
            <?php endif;?>
	  		 ...
	  		 <div class="left-infobox">				
					...
					<ul>													
                        ...
                        <li><a href="<?=erLhcoreClassDesign::baseurl('/gallery/popularrecent/')?>"><?=erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Most popular images in 24 h.');?></a>                 
					</ul>									
             </div>
