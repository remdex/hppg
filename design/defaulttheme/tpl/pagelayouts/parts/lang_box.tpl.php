<div class="ln-box">
   <a href="<?=erLhcoreClassDesign::baseurldirect('/')?>"><img src="<?=erLhcoreClassDesign::design('images/icons/lang/gb.png')?>" title="English"></a>
   <a href="<?=erLhcoreClassDesign::baseurldirect('/fre')?>"><img src="<?=erLhcoreClassDesign::design('images/icons/lang/fr.png')?>" title="Français"></a>
