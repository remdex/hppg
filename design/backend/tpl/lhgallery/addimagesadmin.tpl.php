	...
	<tr>
	   <td colspan="2">
		<ul style="margin:0;padding:0;">
		  <li><?=erTranslationClassLhTranslation::getInstance()->getTranslation('gallery/addimages','Max file size ')?><?=(int)(erLhcoreClassModelSystemConfig::fetch('max_photo_size')->current_value/1024)?> mb.</li>
		</ul>
		</td>
	</tr>
</table>
